...
export function addMainSeries(chart: IChartApi, kind: ChartKind, firstClose: number): ChartMainSeries {
  if (kind === "candles") {
    return chart.addSeries(CandlestickSeries, { upColor: "#22b39b", downColor: "#ef5350", borderUpColor: "#22b39b", borderDownColor: "#ef5350", wickUpColor: "#22b39b", wickDownColor: "#ef5350", priceScaleId: "right" }) as ChartMainSeries;
  }
