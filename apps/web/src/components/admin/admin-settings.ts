...
export const ADMIN_SETTINGS: readonly AdminSettingDefinition[] = [
  ...
  {id:"intelligence.name",section:"intelligence",label:"Intelligence name",type:"text",mutable:true,sensitive:false,description:"Display name for the platform intelligence. Stored as presentation configuration; runtime contracts remain brand-neutral."},
  {id:"intelligence.tagline",section:"intelligence",label:"Intelligence tagline",type:"text",mutable:true,sensitive:false,description:"Short descriptor shown with the intelligence name."},
  {id:"intelligence.provider",section:"intelligence",label:"Intelligence provider",type:"select",mutable:true,sensitive:false,description:"Provider adapter.",options:["deterministic","openai","anthropic","gemini","deepseek","groq","openrouter","ollama","lm-studio"]},
