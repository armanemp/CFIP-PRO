...
export const ADMIN_SETTINGS: readonly AdminSettingDefinition[] = [
  ...
  {id:"market.default_provider",section:"market-data",label:"Default market-data provider",type:"select",mutable:true,sensitive:false,description:"Provider selected for normalized observations."},
  ...
  {id:"intelligence.provider",section:"intelligence",label:"Intelligence provider",type:"select",mutable:true,sensitive:false,description:"Elyrava provider adapter.",options:["deterministic","local","remote"]},
