...
export const ADMIN_SETTINGS: readonly AdminSettingDefinition[] = [
  ...
  {id:"intelligence.name",section:"intelligence",label:"Intelligence name",type:"text",mutable:true,sensitive:false,description:"Human-facing name of the finance intelligence layer; changing it does not change policy or execution behavior."},
  {id:"intelligence.short_name",section:"intelligence",label:"Intelligence short name",type:"text",mutable:true,sensitive:false,description:"Compact terminal/admin label for the configured intelligence identity."},
  {id:"intelligence.provider",section:"intelligence",label:"Intelligence provider",type:"select",mutable:true,sensitive:false,description:"Configured intelligence provider adapter.",options:["deterministic","openai","anthropic","gemini","deepseek","groq","openrouter","ollama","lm-studio"]},
