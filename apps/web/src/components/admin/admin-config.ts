...
export const ADMIN_MODULES: readonly AdminModule[] = [
  ...
  { id:"intelligence", title:"MIOS Intelligence", description:"Analysis, knowledge, model adapters, provenance and governed promotion.", capabilities:["analysis","knowledge","AI adapters","evaluation","promotion"], maturity:"foundation" },
