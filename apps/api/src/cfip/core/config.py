...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default=DEFAULT_INTELLIGENCE_NAME, alias="APP_NAME")
    ...
    admin_control_token: str = Field(default="", alias="ADMIN_CONTROL_TOKEN")
    database_url: str = Field(default="postgresql+asyncpg://cfip:cfip@127.0.0.1:5432/cfip", alias="DATABASE_URL")
