...
| Indicators/market structure | 78% | TA-Lib boundary plus MIOSAI-specific structure contracts exist; parity and broader OSS migration remain. |
...
| MIOSAI intelligence | 63% | Evidence and governed intelligence runtime exist; durable agent/model/training execution remains. |
...
Prefer mature OSS implementations wherever they improve correctness or coverage. Keep MIOSAI-owned contracts, provenance, governance and product UX. Do not add overlapping engines merely for breadth; benchmark first.
...
feat/miosai-platform-unification-2026-09-22
