...
- Aevrix intelligence capabilities;
...
The internal intelligence subsystem is named **Aevrix**.

Aevrix must be governed as an auditable intelligence system, not as an uncontrolled autonomous actor.
