...
- Noverith intelligence capabilities;
...
The internal intelligence subsystem is named **Noverith**.

Noverith must be governed as an auditable intelligence system, not as an uncontrolled autonomous actor.
