...
## Intelligence
Noverith may research, diagnose, evaluate and propose. Code/model/data changes must carry evidence, provenance, validation, rollback information and an explicit promotion boundary.
