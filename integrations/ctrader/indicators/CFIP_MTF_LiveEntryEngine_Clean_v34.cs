// ============================================================================
// CFIP-PRO · Clean Unified MTF Live Entry Engine v34
// ============================================================================
// Advanced single-file cTrader indicator.
//
// Execution pipeline:
//   Closed MTF data → structural/confluence analysis → decision
//   → live reaction/trigger → validated structural plan
//   → authoritative state → chart + panel + alerts + broker protection.
//
// v34 correctness improvements:
//   • TP candidate obstruction is evaluated against the same closed M5 bar.
//   • Initial M5 structural SL no longer depends on trailing configuration.
//   • Optional zone mitigation/retest guards prevent stale zones from scoring.
//   • Adaptive TP selection uses the same regime-aware minimum RR as the plan.
//   • Auto-trade sizing can account for live spread in the risk budget.
//   • Broker protection uses the actual position trade direction.
//   • Manual panel actions can be restricted to managed positions/orders.
//   • AlertSoundType can be honored when semantic sound mapping is disabled.
// ============================================================================
...
namespace cAlgo
{
    public enum CFIPClean34PanelCorner
    {
        TopLeft,
        TopRight,
        BottomLeft,
    ...
    public enum CFIPClean34SizingMode
    {
        RiskPercentEquity = 0,
        FixedLots = 1
    }

    public enum CFIPClean34TargetStage
    {
        TP1 = 0,
        TP2 = 1,
        TP3 = 2,
    ...
    public class CFIP_MTF_LiveEntryEngine_Clean_v34 : Indicator
    {
        ...
        [Parameter("Sizing Mode", Group = "13 · Auto Trading", DefaultValue = CFIPClean34SizingMode.RiskPercentEquity)]
        public CFIPClean34SizingMode SizingMode { get; set; }
        ...
        [Parameter("Auto TP Stage", Group = "13 · Auto Trading", DefaultValue = CFIPClean34TargetStage.TP2)]
        public CFIPClean34TargetStage AutoTpStage { get; set; }
        ...
        [Parameter("Auto Trade Label", Group = "13 · Auto Trading", DefaultValue = "CFIP-SMART-CLEAN34")]
        ...
        [Parameter("Panel Position", Group = "14 · Display", DefaultValue = CFIPClean34PanelCorner.BottomLeft)]
        public CFIPClean34PanelCorner PanelPosition { get; set; }
        ...
        [Parameter("Popup Position", Group = "18 · Alerts", DefaultValue = CFIPClean34PanelCorner.TopRight)]
        public CFIPClean34PanelCorner PopupPosition { get; set; }
        ...
        [Parameter("Aggressive TP Stage", Group = "21 · Auto Intelligence", DefaultValue = CFIPClean34TargetStage.TP1)]
        public CFIPClean34TargetStage AggressiveTpStage { get; set; }
        ...
        private const string P = "CFIP_CLEAN34_";
        private const string H = "CFIP_CLEAN34_H_";
        ...
        private Native RegisterNative(Bars bars)
        {
            ...
            {
                Print(
                    "CFIP CLEAN34 indicator initialization failed: {0}",
                    ex.Message);
            }
            ...
            int closedM5)
        {
                ...
                AlertOnExitPlanUpdate)
            {
                SendUnifiedAlert(
                    ...
                    "|" +
                    Price(_plan.Tp1),
                    "CFIP CLEAN34 SMART PLAN UPDATE | SL " +
                    Price(_plan.Stop) +
                    " | TP1 " +
                    Price(_plan.Tp1) +
                    " | EXIT " +
                    ...
                    false))
            {
                SendUnifiedAlert(
                    "INVALIDPLAN|" +
                    _plan.CreatedM5,
                    "CFIP CLEAN34 PLAN INVALIDATED | STRUCTURE / RR / SPREAD GUARD",
                    _plan.Direction,
                    true);
                    ...
                    FalseSignalAdverseR))
            {
                    ...
                    closedM5)
                {
                    ...
                    SendUnifiedAlert(
                        "INVALID-RISK|" +
                        closedM5,
                        "CFIP CLEAN34 FALSE SIGNAL RISK | " +
                        (_plan.Direction == 1
                            ? "BUY"
                            : "SELL"),
                        0,
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "INVALID|" +
                    closedM5,
                    "CFIP CLEAN34 SETUP UNDER PRESSURE | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | " +
            ...
            double market)
        {
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "STRUCT-INVALID|" +
                    closedM5,
                    "CFIP CLEAN34 STRUCTURAL INVALIDATION | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | SCORE " +
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN34 plan label failed: {0}",
                    ex.Message);
            }
        }
            ...
            bool visible)
        {
            ...
            {
                Print(
                    "CFIP CLEAN34 level render failed [{0}]: {1}",
                    name,
                    ex.Message);
            }
        }
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN34 icon render failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void CreatePanel()
        {
            ...
            {
                Print(
                    "CFIP CLEAN34 panel creation failed: {0}",
                    ex.Message);
        ...
        private void CreatePanelToggleButton()
        {
            ...
            {
                Print(
                    "CFIP CLEAN34 panel toggle failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void SetPanelToggleAlignment()
        {
            ...
            {
                case CFIPClean34PanelCorner.TopLeft:
                ...
                case CFIPClean34PanelCorner.TopRight:
                    _panelToggleButton.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _panelToggleButton.HorizontalAlignment =
                ...
                case CFIPClean34PanelCorner.BottomRight:
                    _panelToggleButton.VerticalAlignment =
            ...
            string message)
        {
            ...
            if (_popup == null)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN34 popup creation failed: {0}",
                        ex.Message);
            ...
            switch (PopupPosition)
            {
                ...
                case CFIPClean34PanelCorner.BottomLeft:
                    _popup.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _popup.HorizontalAlignment =
                        HorizontalAlignment.Left;
            ...
            bool critical)
        {
            ...
            if (EnableSoundAlerts)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN34 sound alert failed: {0}",
                        ex.Message);
                }
            }
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN34 broker protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN34 auto trade failed: {0}",
                    ex.Message);
            }
        }
            ...
            double stopPips)
        {
            try
            {
                ...
                if (SizingMode ==
                    CFIPClean34SizingMode.FixedLots)
                {
                    volume =
            ...
            {
                Print(
                    "CFIP CLEAN34 volume calculation failed: {0}",
                    ex.Message);
        ...
        private double AutoTarget(
            Plan plan,
            CFIPClean34TargetStage stage)
        {
            if (stage ==
                    CFIPClean34TargetStage.TP4 &&
                plan.Tp4 > 0)
                return plan.Tp4;

            if (stage ==
                    CFIPClean34TargetStage.TP3 &&
                plan.Tp3 > 0)
                return plan.Tp3;

            if (stage ==
                    CFIPClean34TargetStage.TP2 &&
                plan.Tp2 > 0)
                return plan.Tp2;
            ...
            double price)
        {
            ...
            {
                Print(
                    "CFIP CLEAN34 prediction render failed: {0}",
                    ex.Message);
            }
        }
            ...
            int closedM5)
        {
            ...
            SendUnifiedAlert(
                ...
                "|" +
                opposite,
                "CFIP CLEAN34 ACTIVE PLAN INVALIDATED | " +
                (opposite == 1
                    ? "BUY"
                    : "SELL") +
                " REVERSAL | Q " +
        ...
        private double AggressiveTargetRR()
        {
            ...
            {
                case CFIPClean34TargetStage.TP4:
                    return Math.Max(
                        3.0,
                        Tp4MinimumRR);

                case CFIPClean34TargetStage.TP3:
                    return Math.Max(
                        2.5,
                        Tp3MinimumRR);

                case CFIPClean34TargetStage.TP2:
                    return Math.Max(
                        2.0,
                        Tp2MinimumRR);
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN34 aggressive protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN34 aggressive auto trade failed: {0}",
                    ex.Message);
            }
        }
