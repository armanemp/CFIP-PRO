// ============================================================================
// CFIP-PRO · Clean Unified MTF Live Entry Engine v45
// ============================================================================
...
namespace cAlgo
{
    public enum CFIPClean45PanelCorner
    {
        TopLeft,
        TopRight,
        BottomLeft,
    ...
    public enum CFIPClean45SizingMode
    {
        RiskPercentEquity = 0,
        FixedLots = 1
    }

    public enum CFIPClean45TargetStage
    {
        TP1 = 0,
        TP2 = 1,
        TP3 = 2,
    ...
    public class CFIP_MTF_LiveEntryEngine_Clean_v45 : Indicator
    {
        ...
        [Parameter("Sizing Mode", Group = "13 · AUTO TRADING", DefaultValue = CFIPClean45SizingMode.RiskPercentEquity)]
        public CFIPClean45SizingMode SizingMode { get; set; }
        ...
        [Parameter("Auto TP Stage", Group = "13 · AUTO TRADING", DefaultValue = CFIPClean45TargetStage.TP2)]
        public CFIPClean45TargetStage AutoTpStage { get; set; }
        ...
        [Parameter("Auto Trade Label", Group = "13 · AUTO TRADING", DefaultValue = "CFIP-SMART-CLEAN45")]
        ...
        [Parameter("Panel Position", Group = "14 · DISPLAY — CORE", DefaultValue = CFIPClean45PanelCorner.BottomLeft)]
        public CFIPClean45PanelCorner PanelPosition { get; set; }
        ...
        [Parameter("Popup Position", Group = "12 · ALERTS — ADVANCED", DefaultValue = CFIPClean45PanelCorner.TopRight)]
        public CFIPClean45PanelCorner PopupPosition { get; set; }
        ...
        [Parameter("Aggressive TP Stage", Group = "13 · AUTO TRADING", DefaultValue = CFIPClean45TargetStage.TP1)]
        public CFIPClean45TargetStage AggressiveTpStage { get; set; }
        ...
        private const string P = "CFIP_CLEAN45_";
        private const string H = "CFIP_CLEAN45_H_";
        ...
        private Native RegisterNative(Bars bars)
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 indicator initialization failed: {0}",
                    ex.Message);
            }
            ...
            int closedM5)
        {
                ...
                AlertOnExitPlanUpdate)
            {
                SendUnifiedAlert(
                    ...
                    "|" +
                    Price(_plan.Tp1),
                    "CFIP CLEAN45 SMART PLAN UPDATE | SL " +
                    Price(_plan.Stop) +
                    " | TP1 " +
                    Price(_plan.Tp1) +
                    " | EXIT " +
                    ...
                    false))
            {
                SendUnifiedAlert(
                    "INVALIDPLAN|" +
                    _plan.CreatedM5,
                    "CFIP CLEAN45 PLAN INVALIDATED | STRUCTURE / RR / SPREAD GUARD",
                    _plan.Direction,
                    true);
                    ...
                    FalseSignalAdverseR))
            {
                    ...
                    closedM5)
                {
                    ...
                    SendUnifiedAlert(
                        "INVALID-RISK|" +
                        closedM5,
                        "CFIP CLEAN45 FALSE SIGNAL RISK | " +
                        (_plan.Direction == 1
                            ? "BUY"
                            : "SELL"),
                        0,
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "INVALID|" +
                    closedM5,
                    "CFIP CLEAN45 SETUP UNDER PRESSURE | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | " +
            ...
            double market)
        {
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "STRUCT-INVALID|" +
                    closedM5,
                    "CFIP CLEAN45 STRUCTURAL INVALIDATION | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | SCORE " +
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 plan label failed: {0}",
                    ex.Message);
            }
        }
            ...
            bool visible)
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 level render failed [{0}]: {1}",
                    name,
                    ex.Message);
            }
        }
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 icon render failed: {0}",
                    ex.Message);
            }
        }
                ...
                private void CreatePanel()
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 panel creation failed: {0}",
                    ex.Message);
                ...
                private void CreatePanelToggleButton()
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 panel hide button failed: {0}",
                    ex.Message);
                ...
                private void CreatePanelRestoreButton()
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 panel restore button failed: {0}",
                    ex.Message);
        ...
        private void SetPanelRestoreAlignment()
        {
            ...
            {
                case CFIPClean45PanelCorner.TopLeft:
                ...
                case CFIPClean45PanelCorner.TopRight:
                    _panelRestoreButton.VerticalAlignment =
                        VerticalAlignment.Top;
                    _panelRestoreButton.HorizontalAlignment =
                ...
                case CFIPClean45PanelCorner.BottomRight:
                    _panelRestoreButton.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _panelRestoreButton.HorizontalAlignment =
                        HorizontalAlignment.Right;
            ...
            int contentWidth)
        {
            ...
            AddPanelRow(
                ...
                "  •  " +
                (SizingMode ==
                    CFIPClean45SizingMode.FixedLots
                    ? "FIXED " +
            ...
            string message)
        {
            ...
            if (_popup == null)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN45 popup creation failed: {0}",
                        ex.Message);
            ...
            switch (PopupPosition)
            {
                ...
                case CFIPClean45PanelCorner.BottomLeft:
                    _popup.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _popup.HorizontalAlignment =
                        HorizontalAlignment.Left;
            ...
            bool critical)
        {
            ...
            if (EnableSoundAlerts)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN45 sound alert failed: {0}",
                        ex.Message);
                }
            }
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN45 broker protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                Print(
                    "CFIP CLEAN45 auto trade failed: {0}",
                    ex.Message);
            }
        }
            ...
            double stopPips)
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 volume calculation failed: {0}",
                    ex.Message);
        ...
        {
            if (stage ==
                    CFIPClean45TargetStage.TP4 &&
                plan.Tp4 > 0)
                return plan.Tp4;

            if (stage ==
                    CFIPClean45TargetStage.TP3 &&
                plan.Tp3 > 0)
                return plan.Tp3;

            if (stage ==
                    CFIPClean45TargetStage.TP2 &&
                plan.Tp2 > 0)
                return plan.Tp2;
            ...
            double price)
        {
            ...
            {
                Print(
                    "CFIP CLEAN45 prediction render failed: {0}",
                    ex.Message);
            }
        }
            ...
            int closedM5)
        {
            ...
            SendUnifiedAlert(
                ...
                "|" +
                opposite,
                "CFIP CLEAN45 ACTIVE PLAN INVALIDATED | " +
                (opposite == 1
                    ? "BUY"
                    : "SELL") +
                " REVERSAL | Q " +
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN45 aggressive protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN45 aggressive auto trade failed: {0}",
                    ex.Message);
            }
        }
