...
namespace cAlgo
{
    ...
    public class CFIP_MTF_LiveEntryEngine_Clean_v31 : Indicator
    {
        // ============================================================
        // 01 · DECISION
        // ============================================================
        ...
        [Parameter("Auto Trade Label", Group = "13 · Auto Trading", DefaultValue = "CFIP-SMART-CLEAN31")]
        ...
        private Native RegisterNative(Bars bars)
        {
            ...
            {
                Print(
                    "CFIP CLEAN31 indicator initialization failed: {0}",
                    ex.Message);
            }
            ...
            int closedM5)
        {
                ...
                AlertOnExitPlanUpdate)
            {
                SendUnifiedAlert(
                    ...
                    "|" +
                    Price(_plan.Tp1),
                    "CFIP CLEAN31 SMART PLAN UPDATE | SL " +
                    Price(_plan.Stop) +
                    " | TP1 " +
                    Price(_plan.Tp1) +
                    " | EXIT " +
                    ...
                    false))
            {
                SendUnifiedAlert(
                    "INVALIDPLAN|" +
                    _plan.CreatedM5,
                    "CFIP CLEAN31 PLAN INVALIDATED | STRUCTURE / RR / SPREAD GUARD",
                    _plan.Direction,
                    true);
                    ...
                    FalseSignalAdverseR))
            {
                    ...
                    closedM5)
                {
                    ...
                    SendUnifiedAlert(
                        "INVALID-RISK|" +
                        closedM5,
                        "CFIP CLEAN31 FALSE SIGNAL RISK | " +
                        (_plan.Direction == 1
                            ? "BUY"
                            : "SELL"),
                        0,
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "INVALID|" +
                    closedM5,
                    "CFIP CLEAN31 SETUP UNDER PRESSURE | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | " +
            ...
            double market)
        {
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "STRUCT-INVALID|" +
                    closedM5,
                    "CFIP CLEAN31 STRUCTURAL INVALIDATION | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | SCORE " +
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN31 plan label failed: {0}",
                    ex.Message);
            }
        }
            ...
            bool visible)
        {
            ...
            {
                Print(
                    "CFIP CLEAN31 level render failed [{0}]: {1}",
                    name,
                    ex.Message);
            }
        }
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN31 icon render failed: {0}",
                    ex.Message);
            }
        }
        ...
        private const int PanelRowCount = 48;
        ...
        private void CreatePanel()
        {
            ...
            {
                Print(
                    "CFIP CLEAN31 panel creation failed: {0}",
                    ex.Message);
        ...
        private void CreatePanelToggleButton()
        {
            ...
            {
                Print(
                    "CFIP CLEAN31 panel toggle failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void SetPanelToggleAlignment()
        {
            ...
            switch (PanelPosition)
            {
                ...
                case CFIPClean31PanelCorner.TopRight:
                    _panelToggleButton.VerticalAlignment =
                        VerticalAlignment.Top;
                    _panelToggleButton.HorizontalAlignment =
            ...
            string message)
        {
            ...
            if (_popup == null)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN31 popup creation failed: {0}",
                        ex.Message);
            ...
            bool critical)
        {
            ...
            if (EnableSoundAlerts)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN31 sound alert failed: {0}",
                        ex.Message);
                }
            }
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN31 broker protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN31 auto trade failed: {0}",
                    ex.Message);
            }
        }
            ...
            double stopPips)
        {
            ...
            {
                Print(
                    "CFIP CLEAN31 volume calculation failed: {0}",
                    ex.Message);
            ...
            double price)
        {
            ...
            {
                Print(
                    "CFIP CLEAN31 prediction render failed: {0}",
                    ex.Message);
            }
        }
            ...
            int closedM5)
        {
            ...
            SendUnifiedAlert(
                ...
                "|" +
                opposite,
                "CFIP CLEAN31 ACTIVE PLAN INVALIDATED | " +
                (opposite == 1
                    ? "BUY"
                    : "SELL") +
                " REVERSAL | Q " +
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN31 aggressive protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN31 aggressive auto trade failed: {0}",
                    ex.Message);
            }
        }
