// ============================================================================
// CFIP-PRO · Clean Unified MTF Live Entry Engine v44
// ============================================================================
...
namespace cAlgo
{
    public enum CFIPClean44PanelCorner
    {
        TopLeft,
        TopRight,
        BottomLeft,
    ...
    public enum CFIPClean44SizingMode
    {
        RiskPercentEquity = 0,
        FixedLots = 1
    }

    public enum CFIPClean44TargetStage
    {
        TP1 = 0,
        TP2 = 1,
        TP3 = 2,
    ...
    public class CFIP_MTF_LiveEntryEngine_Clean_v44 : Indicator
    {
        ...
        [Parameter("Sizing Mode", Group = "13 · AUTO TRADING — CORE", DefaultValue = CFIPClean44SizingMode.RiskPercentEquity)]
        public CFIPClean44SizingMode SizingMode { get; set; }
        ...
        [Parameter("Auto TP Stage", Group = "13 · AUTO TRADING — CORE", DefaultValue = CFIPClean44TargetStage.TP2)]
        public CFIPClean44TargetStage AutoTpStage { get; set; }
        ...
        [Parameter("Auto Trade Label", Group = "13 · AUTO TRADING — CORE", DefaultValue = "CFIP-SMART-CLEAN44")]
        ...
        [Parameter("Panel Position", Group = "14 · DISPLAY — CORE", DefaultValue = CFIPClean44PanelCorner.BottomLeft)]
        public CFIPClean44PanelCorner PanelPosition { get; set; }
        ...
        [Parameter("Popup Position", Group = "12 · ALERTS — ADVANCED", DefaultValue = CFIPClean44PanelCorner.TopRight)]
        public CFIPClean44PanelCorner PopupPosition { get; set; }
        ...
        [Parameter("Aggressive TP Stage", Group = "13 · AUTO TRADING — INTELLIGENCE", DefaultValue = CFIPClean44TargetStage.TP1)]
        public CFIPClean44TargetStage AggressiveTpStage { get; set; }
        ...
        private const string P = "CFIP_CLEAN44_";
        private const string H = "CFIP_CLEAN44_H_";
        ...
        private Native RegisterNative(Bars bars)
        {
            ...
            {
                Print(
                    "CFIP CLEAN44 indicator initialization failed: {0}",
                    ex.Message);
            }
            ...
            int closedM5)
        {
                ...
                AlertOnExitPlanUpdate)
            {
                SendUnifiedAlert(
                    ...
                    "|" +
                    Price(_plan.Tp1),
                    "CFIP CLEAN44 SMART PLAN UPDATE | SL " +
                    Price(_plan.Stop) +
                    " | TP1 " +
                    Price(_plan.Tp1) +
                    " | EXIT " +
                    ...
                    false))
            {
                SendUnifiedAlert(
                    "INVALIDPLAN|" +
                    _plan.CreatedM5,
                    "CFIP CLEAN44 PLAN INVALIDATED | STRUCTURE / RR / SPREAD GUARD",
                    _plan.Direction,
                    true);
                    ...
                    FalseSignalAdverseR))
            {
                    ...
                    closedM5)
                {
                    ...
                    SendUnifiedAlert(
                        "INVALID-RISK|" +
                        closedM5,
                        "CFIP CLEAN44 FALSE SIGNAL RISK | " +
                        (_plan.Direction == 1
                            ? "BUY"
                            : "SELL"),
                        0,
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "INVALID|" +
                    closedM5,
                    "CFIP CLEAN44 SETUP UNDER PRESSURE | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | " +
            ...
            double market)
        {
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "STRUCT-INVALID|" +
                    closedM5,
                    "CFIP CLEAN44 STRUCTURAL INVALIDATION | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | SCORE " +
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN44 plan label failed: {0}",
                    ex.Message);
            }
        }
            ...
            bool visible)
        {
            ...
            {
                Print(
                    "CFIP CLEAN44 level render failed [{0}]: {1}",
                    name,
                    ex.Message);
            }
        }
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN44 icon render failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void CreatePanel()
        {
            ...
            {
                Print(
                    "CFIP CLEAN44 panel creation failed: {0}",
                    ex.Message);
        ...
        private void CreatePanelToggleButton()
        {
            ...
            {
                Print(
                    "CFIP CLEAN44 panel toggle failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void SetPanelToggleAlignment()
        {
            ...
            {
                case CFIPClean44PanelCorner.TopLeft:
                ...
                case CFIPClean44PanelCorner.TopRight:
                    _panelToggleButton.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _panelToggleButton.HorizontalAlignment =
                ...
                case CFIPClean44PanelCorner.BottomRight:
                    _panelToggleButton.VerticalAlignment =
            ...
            int buttonGap)
        {
            ...
            if (_panelToggleButton != null)
            {
                ...
                SetPanelToggleAlignment();
                        ...
                        private int EstimatePanelContentHeight(
            int contentWidth,
            ...
            int contentWidth)
        {
            ...
            AddPanelRow(
                ...
                "  •  " +
                (SizingMode ==
                    CFIPClean44SizingMode.FixedLots
                    ? "FIXED " +
            ...
            string message)
        {
            ...
            if (_popup == null)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN44 popup creation failed: {0}",
                        ex.Message);
            ...
            switch (PopupPosition)
            {
                ...
                case CFIPClean44PanelCorner.BottomLeft:
                    _popup.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _popup.HorizontalAlignment =
                        HorizontalAlignment.Left;
            ...
            bool critical)
        {
            ...
            if (EnableSoundAlerts)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN44 sound alert failed: {0}",
                        ex.Message);
                }
            }
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN44 broker protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN44 auto trade failed: {0}",
                    ex.Message);
            }
        }
            ...
            double stopPips)
        {
            ...
            {
                Print(
                    "CFIP CLEAN44 volume calculation failed: {0}",
                    ex.Message);
        ...
        private double AutoTarget(
            Plan plan,
            CFIPClean44TargetStage stage)
        {
            if (stage ==
                    CFIPClean44TargetStage.TP4 &&
                plan.Tp4 > 0)
                return plan.Tp4;

            if (stage ==
                    CFIPClean44TargetStage.TP3 &&
                plan.Tp3 > 0)
                return plan.Tp3;

            if (stage ==
                    CFIPClean44TargetStage.TP2 &&
                plan.Tp2 > 0)
                return plan.Tp2;
            ...
            double price)
        {
            ...
            {
                Print(
                    "CFIP CLEAN44 prediction render failed: {0}",
                    ex.Message);
            }
        }
            ...
            int closedM5)
        {
            ...
            SendUnifiedAlert(
                ...
                "|" +
                opposite,
                "CFIP CLEAN44 ACTIVE PLAN INVALIDATED | " +
                (opposite == 1
                    ? "BUY"
                    : "SELL") +
                " REVERSAL | Q " +
        ...
        private double AggressiveTargetRR()
        {
            ...
            {
                case CFIPClean44TargetStage.TP4:
                    return Math.Max(
                        3.0,
                        Tp4MinimumRR);

                case CFIPClean44TargetStage.TP3:
                    return Math.Max(
                        2.5,
                        Tp3MinimumRR);

                case CFIPClean44TargetStage.TP2:
                    return Math.Max(
                        2.0,
                        Tp2MinimumRR);
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN44 aggressive protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN44 aggressive auto trade failed: {0}",
                    ex.Message);
            }
        }
