// ============================================================================
// CFIP-PRO · Clean Unified MTF Live Entry Engine v48
// ============================================================================
...
namespace cAlgo
{
    public enum CFIPClean48PanelCorner
    {
        TopLeft,
        TopRight,
        BottomLeft,
    ...
    public enum CFIPClean48SizingMode
    {
        RiskPercentEquity = 0,
        FixedLots = 1
    }

    public enum CFIPClean48TargetStage
    {
        TP1 = 0,
        TP2 = 1,
        TP3 = 2,
    ...
    public class CFIP_MTF_LiveEntryEngine_Clean_v48 : Indicator
    {
        ...
        [Parameter("Sizing Mode", Group = "13 · AUTO TRADING", DefaultValue = CFIPClean48SizingMode.RiskPercentEquity)]
        public CFIPClean48SizingMode SizingMode { get; set; }
        ...
        [Parameter("Auto TP Stage", Group = "13 · AUTO TRADING", DefaultValue = CFIPClean48TargetStage.TP2)]
        public CFIPClean48TargetStage AutoTpStage { get; set; }
        ...
        [Parameter("Panel Position", Group = "14 · DISPLAY — CORE", DefaultValue = CFIPClean48PanelCorner.BottomLeft)]
        public CFIPClean48PanelCorner PanelPosition { get; set; }
        ...
        [Parameter("Popup Position", Group = "12 · ALERTS — ADVANCED", DefaultValue = CFIPClean48PanelCorner.TopRight)]
        public CFIPClean48PanelCorner PopupPosition { get; set; }
        ...
        [Parameter("Aggressive TP Stage", Group = "13 · AUTO TRADING", DefaultValue = CFIPClean48TargetStage.TP1)]
        public CFIPClean48TargetStage AggressiveTpStage { get; set; }
        ...
        private const string P = "CFIP_CLEAN48_";
        private const string H = "CFIP_CLEAN48_H_";
        ...
        private void SetPanelRestoreAlignment()
        {
            ...
            {
                case CFIPClean48PanelCorner.TopLeft:
                ...
                case CFIPClean48PanelCorner.TopRight:
                    _panelRestoreButton.VerticalAlignment =
                        VerticalAlignment.Top;
                    _panelRestoreButton.HorizontalAlignment =
                ...
                case CFIPClean48PanelCorner.BottomRight:
                    _panelRestoreButton.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _panelRestoreButton.HorizontalAlignment =
                        HorizontalAlignment.Right;
            ...
            int contentWidth)
        {
            ...
            AddPanelRow(
                ...
                "  •  " +
                (SizingMode ==
                    CFIPClean48SizingMode.FixedLots
                    ? "FIXED " +
            ...
            string message)
        {
            ...
            switch (PopupPosition)
            {
                ...
                case CFIPClean48PanelCorner.BottomLeft:
                    _popup.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _popup.HorizontalAlignment =
                        HorizontalAlignment.Left;
        ...
        {
            if (stage ==
                    CFIPClean48TargetStage.TP4 &&
                plan.Tp4 > 0)
                return plan.Tp4;

            if (stage ==
                    CFIPClean48TargetStage.TP3 &&
                plan.Tp3 > 0)
                return plan.Tp3;

            if (stage ==
                    CFIPClean48TargetStage.TP2 &&
                plan.Tp2 > 0)
                return plan.Tp2;
