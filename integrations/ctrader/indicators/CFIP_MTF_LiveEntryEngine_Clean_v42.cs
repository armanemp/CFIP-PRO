// ============================================================================
// CFIP-PRO · Clean Unified MTF Live Entry Engine v42
// ============================================================================
...
namespace cAlgo
{
    public enum CFIPClean42PanelCorner
    {
        TopLeft,
        TopRight,
        BottomLeft,
    ...
    public enum CFIPClean42SizingMode
    {
        RiskPercentEquity = 0,
        FixedLots = 1
    }

    public enum CFIPClean42TargetStage
    {
        TP1 = 0,
        TP2 = 1,
        TP3 = 2,
    ...
    public class CFIP_MTF_LiveEntryEngine_Clean_v42 : Indicator
    {
        ...
        [Parameter("Enable Auto Trading", Group = "13 · AUTO TRADING — CORE", DefaultValue = false)]
        public bool EnableAutoTrading { get; set; }

        [Parameter("Confirmed Signals Only", Group = "13 · AUTO TRADING — CORE", DefaultValue = true)]
        public bool ConfirmedSignalsOnly { get; set; }

        [Parameter("Sizing Mode", Group = "13 · AUTO TRADING — CORE", DefaultValue = CFIPClean42SizingMode.RiskPercentEquity)]
        public CFIPClean42SizingMode SizingMode { get; set; }

        [Parameter("Risk % Equity", Group = "13 · AUTO TRADING — CORE", DefaultValue = 0.50, MinValue = 0.05, MaxValue = 5)]
        public double RiskPercentEquity { get; set; }

        [Parameter("Fixed Lots", Group = "13 · AUTO TRADING — CORE", DefaultValue = 0.01, MinValue = 0.001, MaxValue = 100, Step = 0.001)]
        public double FixedLots { get; set; }

        [Parameter("Minimum Auto Confidence", Group = "13 · AUTO TRADING — CORE", DefaultValue = 86, MinValue = 50, MaxValue = 99)]
        public int MinimumAutoConfidence { get; set; }

        [Parameter("Minimum Auto Smart Quality", Group = "13 · AUTO TRADING — CORE", DefaultValue = 80, MinValue = 50, MaxValue = 95)]
        public int MinimumAutoSmartQuality { get; set; }

        [Parameter("Minimum Auto Level Quality", Group = "13 · AUTO TRADING — CORE", DefaultValue = 72, MinValue = 40, MaxValue = 100)]
        public int MinimumAutoLevelQuality { get; set; }

        [Parameter("Auto TP Stage", Group = "13 · AUTO TRADING — CORE", DefaultValue = CFIPClean42TargetStage.TP2)]
        public CFIPClean42TargetStage AutoTpStage { get; set; }

        [Parameter("Maximum Open Positions", Group = "13 · AUTO TRADING — CORE", DefaultValue = 1, MinValue = 1, MaxValue = 20)]
        public int MaximumOpenPositions { get; set; }

        [Parameter("Use Market Hours Guard", Group = "13 · AUTO TRADING — CORE", DefaultValue = true)]
        public bool UseMarketHoursGuard { get; set; }

        [Parameter("Use Auto Margin Guard", Group = "13 · AUTO TRADING — CORE", DefaultValue = true)]
        public bool UseAutoMarginGuard { get; set; }

        [Parameter("Max Auto Margin Usage %", Group = "13 · AUTO TRADING — CORE", DefaultValue = 80, MinValue = 10, MaxValue = 100)]
        public double MaxAutoMarginUsagePercent { get; set; }

        [Parameter("Auto Trade Label", Group = "13 · AUTO TRADING — CORE", DefaultValue = "CFIP-SMART-CLEAN42")]
        public string AutoTradeLabel { get; set; }

        [Parameter("Auto Broker Protection", Group = "13 · AUTO TRADING — CORE", DefaultValue = true)]
        public bool AutoBrokerProtection { get; set; }

        [Parameter("One Order Per Signal", Group = "13 · AUTO TRADING — CORE", DefaultValue = true)]
        ...
        [Parameter("Panel Position", Group = "14 · Display", DefaultValue = CFIPClean42PanelCorner.BottomLeft)]
        public CFIPClean42PanelCorner PanelPosition { get; set; }
        ...
        [Parameter("Panel Background Alpha", Group = "14 · Display", DefaultValue = 145, MinValue = 0, MaxValue = 255)]
        ...
        [Parameter("Panel Max Height", Group = "14 · Display", DefaultValue = 650, MinValue = 260, MaxValue = 1200)]
        public int PanelMaxHeight { get; set; }

        [Parameter("Panel Row Padding", Group = "14 · Display", DefaultValue = 3, MinValue = 0, MaxValue = 12)]
        public int PanelRowPadding { get; set; }

        [Parameter("Panel Button Gap", Group = "14 · Display", DefaultValue = 4, MinValue = 0, MaxValue = 16)]
        public int PanelButtonGap { get; set; }

        [Parameter("Panel Accent Color", Group = "14 · Display", DefaultValue = "#4A90E2")]
        public Color PanelAccentColor { get; set; }

        [Parameter("Panel Section Color", Group = "14 · Display", DefaultValue = "#8FA3B8")]
        public Color PanelSectionColor { get; set; }

        [Parameter("Panel Secondary Text Color", Group = "14 · Display", DefaultValue = "#C5CBD3")]
        public Color PanelSecondaryTextColor { get; set; }

        [Parameter("Panel Muted Text Color", Group = "14 · Display", DefaultValue = "#8A95A5")]
        public Color PanelMutedTextColor { get; set; }

        [Parameter("Panel Warning Color", Group = "14 · Display", DefaultValue = "Orange")]
        ...
        [Parameter("Show Trade Action Buttons", Group = "13 · AUTO TRADING — ACTIONS", DefaultValue = true)]
        public bool ShowTradeActionButtons { get; set; }

        [Parameter("Action Button Margin", Group = "13 · AUTO TRADING — ACTIONS", DefaultValue = 2, MinValue = 0, MaxValue = 20)]
        public int ActionButtonMargin { get; set; }

        [Parameter("Use Authoritative Signal State", Group = "22 · Complete Intelligence", DefaultValue = true)]
        public bool UseAuthoritativeSignalState { get; set; }

        [Parameter("Require Plan Integrity", Group = "22 · Complete Intelligence", DefaultValue = true)]
        public bool RequirePlanIntegrity { get; set; }

        [Parameter("Maximum Spread / Stop Risk Ratio", Group = "22 · Complete Intelligence", DefaultValue = 0.18, MinValue = 0.02, MaxValue = 0.50, Step = 0.01)]
        public double MaximumSpreadToStopRiskRatio { get; set; }

        [Parameter("Minimum Smart Target Quality For TP1", Group = "22 · Complete Intelligence", DefaultValue = 55, MinValue = 40, MaxValue = 95)]
        ...
        [Parameter("Require Precision Entry", Group = "24 · Structural Execution", DefaultValue = true)]
        public bool RequirePrecisionEntry { get; set; }

        [Parameter("Execution Zone ATR", Group = "24 · Structural Execution", DefaultValue = 0.35, MinValue = 0.05, MaxValue = 1.50, Step = 0.01)]
        public double ExecutionZoneAtr { get; set; }

        [Parameter("Minimum Entry Quality", Group = "24 · Structural Execution", DefaultValue = 72, MinValue = 40, MaxValue = 100)]
        public int MinimumEntryQuality { get; set; }

        [Parameter("Maximum Entry Distance ATR", Group = "24 · Structural Execution", DefaultValue = 0.45, MinValue = 0.05, MaxValue = 2.0, Step = 0.01)]
        public double MaximumEntryDistanceAtr { get; set; }

        [Parameter("Allow Precision Breakout Entry", Group = "24 · Structural Execution", DefaultValue = true)]
        public bool AllowPrecisionBreakoutEntry { get; set; }

        [Parameter("Precision Breakout Buffer ATR", Group = "24 · Structural Execution", DefaultValue = 0.08, MinValue = 0.01, MaxValue = 0.50, Step = 0.01)]
        public double PrecisionBreakoutBufferAtr { get; set; }

        [Parameter("Minimum Targets For Plan", Group = "24 · Structural Execution", DefaultValue = 2, MinValue = 1, MaxValue = 4)]
        public int MinimumTargetsForPlan { get; set; }

        [Parameter("Require HTF Reward For TP1", Group = "24 · Structural Execution", DefaultValue = false)]
        public bool RequireHtfRewardForTp1 { get; set; }

        [Parameter("Require HTF Reward For TP2+", Group = "24 · Structural Execution", DefaultValue = true)]
        public bool RequireHtfRewardForTp2Plus { get; set; }

        [Parameter("Minimum HTF Reward Quality", Group = "24 · Structural Execution", DefaultValue = 68, MinValue = 40, MaxValue = 100)]
        public int MinimumHtfRewardQuality { get; set; }

        [Parameter("Maximum Reward RR", Group = "24 · Structural Execution", DefaultValue = 10.0, MinValue = 2.0, MaxValue = 40, Step = 0.10)]
        public double MaximumRewardRR { get; set; }

        [Parameter("HTF Reward Bonus", Group = "24 · Structural Execution", DefaultValue = 18, MinValue = 0, MaxValue = 40)]
        public int HtfRewardBonus { get; set; }

        [Parameter("Liquidity Reward Bonus", Group = "24 · Structural Execution", DefaultValue = 14, MinValue = 0, MaxValue = 40)]
        public int LiquidityRewardBonus { get; set; }

        [Parameter("Zone Reward Bonus", Group = "24 · Structural Execution", DefaultValue = 10, MinValue = 0, MaxValue = 30)]
        public int ZoneRewardBonus { get; set; }

        [Parameter("Preferred Stop Risk ATR", Group = "24 · Structural Execution", DefaultValue = 1.00, MinValue = 0.25, MaxValue = 3.0, Step = 0.05)]
        public double PreferredStopRiskAtr { get; set; }

        [Parameter("Stop Risk Balance Weight", Group = "24 · Structural Execution", DefaultValue = 18, MinValue = 0, MaxValue = 40)]
        public int StopRiskBalanceWeight { get; set; }

        [Parameter("Minimum Structural Stop Quality", Group = "24 · Structural Execution", DefaultValue = 65, MinValue = 40, MaxValue = 100)]
        public int MinimumStructuralStopQuality { get; set; }

        [Parameter("Structural Stop Management Only", Group = "24 · Structural Execution", DefaultValue = true)]
        public bool StructuralStopManagementOnly { get; set; }

        [Parameter("Structural Target Updates Only", Group = "24 · Structural Execution", DefaultValue = true)]
        ...
        [Parameter("Use M5 Structure For Initial Stop", Group = "23 · Safety & Precision", DefaultValue = true)]
        public bool UseM5StructureForStop { get; set; }

        [Parameter("Use Zone Mitigation Guard", Group = "23 · Safety & Precision", DefaultValue = true)]
        public bool UseZoneMitigationGuard { get; set; }

        [Parameter("Require Order Block Retest", Group = "23 · Safety & Precision", DefaultValue = false)]
        public bool RequireObRetest { get; set; }

        [Parameter("FVG Invalidate On Full Fill", Group = "23 · Safety & Precision", DefaultValue = true)]
        public bool FvgInvalidateOnFullFill { get; set; }

        [Parameter("FVG Partial Mitigation", Group = "23 · Safety & Precision", DefaultValue = true)]
        public bool EnableFvgPartialMitigation { get; set; }

        [Parameter("FVG Break By Wicks", Group = "23 · Safety & Precision", DefaultValue = false)]
        public bool FvgBreakByWicks { get; set; }

        [Parameter("Include Spread In Risk Sizing", Group = "13 · AUTO TRADING — PROTECTION", DefaultValue = true)]
        public bool IncludeSpreadInRiskSizing { get; set; }

        [Parameter("Use Semantic Alert Sounds", Group = "23 · Safety & Precision", DefaultValue = true)]
        public bool UseSemanticAlertSounds { get; set; }

        [Parameter("Managed Actions Only", Group = "13 · AUTO TRADING — PROTECTION", DefaultValue = false)]
        ...
        [Parameter("Popup Position", Group = "18 · Alerts", DefaultValue = CFIPClean42PanelCorner.TopRight)]
        public CFIPClean42PanelCorner PopupPosition { get; set; }
        ...
        [Parameter("Action Button Width", Group = "13 · AUTO TRADING — ACTIONS", DefaultValue = 150, MinValue = 100, MaxValue = 240)]
        public int ActionButtonWidth { get; set; }

        [Parameter("Action Button Height", Group = "13 · AUTO TRADING — ACTIONS", DefaultValue = 25, MinValue = 20, MaxValue = 50)]
        public int ActionButtonHeight { get; set; }

        [Parameter("Auto Protect Broker Positions", Group = "13 · AUTO TRADING — PROTECTION", DefaultValue = false)]
        public bool AutoProtectBrokerPositions { get; set; }

        [Parameter("Managed Position Label", Group = "13 · AUTO TRADING — PROTECTION", DefaultValue = "")]
        public string ManagedPositionLabel { get; set; }

        [Parameter("Sync Broker Take Profit", Group = "13 · AUTO TRADING — PROTECTION", DefaultValue = false)]
        public bool SyncBrokerTakeProfit { get; set; }

        [Parameter("Prevent Broker TP Backward Move", Group = "13 · AUTO TRADING — PROTECTION", DefaultValue = true)]
        public bool PreventBrokerTpBackwardMove { get; set; }

        [Parameter("Broker Modify Cooldown ms", Group = "13 · AUTO TRADING — PROTECTION", DefaultValue = 750, MinValue = 100, MaxValue = 5000, Step = 50)]
        public int BrokerModifyCooldownMs { get; set; }

        [Parameter("Enable Aggressive Auto Entry", Group = "13 · AUTO TRADING — INTELLIGENCE", DefaultValue = false)]
        public bool EnableAggressiveAutoEntry { get; set; }

        [Parameter("Aggressive Minimum Confidence", Group = "13 · AUTO TRADING — INTELLIGENCE", DefaultValue = 88, MinValue = 50, MaxValue = 99)]
        public int AggressiveMinimumConfidence { get; set; }

        [Parameter("Aggressive Minimum Evidence", Group = "13 · AUTO TRADING — INTELLIGENCE", DefaultValue = 4, MinValue = 1, MaxValue = 8)]
        public int AggressiveMinimumEvidence { get; set; }

        [Parameter("Aggressive Minimum Smart Quality", Group = "13 · AUTO TRADING — INTELLIGENCE", DefaultValue = 78, MinValue = 50, MaxValue = 95)]
        public int AggressiveMinimumSmartQuality { get; set; }

        [Parameter("Aggressive Risk % Equity", Group = "13 · AUTO TRADING — INTELLIGENCE", DefaultValue = 0.25, MinValue = 0.05, MaxValue = 5)]
        public double AggressiveRiskPercentEquity { get; set; }

        [Parameter("Aggressive TP Stage", Group = "13 · AUTO TRADING — INTELLIGENCE", DefaultValue = CFIPClean42TargetStage.TP1)]
        public CFIPClean42TargetStage AggressiveTpStage { get; set; }

        [Parameter("Aggressive Require Smart Agreement", Group = "13 · AUTO TRADING — INTELLIGENCE", DefaultValue = true)]
        ...
        private const string P = "CFIP_CLEAN42_";
        private const string H = "CFIP_CLEAN42_H_";
        ...
        private Native RegisterNative(Bars bars)
        {
            ...
            {
                Print(
                    "CFIP CLEAN42 indicator initialization failed: {0}",
                    ex.Message);
            }
            ...
            int closedM5)
        {
                ...
                AlertOnExitPlanUpdate)
            {
                SendUnifiedAlert(
                    ...
                    "|" +
                    Price(_plan.Tp1),
                    "CFIP CLEAN42 SMART PLAN UPDATE | SL " +
                    Price(_plan.Stop) +
                    " | TP1 " +
                    Price(_plan.Tp1) +
                    " | EXIT " +
                    ...
                    false))
            {
                SendUnifiedAlert(
                    "INVALIDPLAN|" +
                    _plan.CreatedM5,
                    "CFIP CLEAN42 PLAN INVALIDATED | STRUCTURE / RR / SPREAD GUARD",
                    _plan.Direction,
                    true);
                    ...
                    FalseSignalAdverseR))
            {
                    ...
                    closedM5)
                {
                    ...
                    SendUnifiedAlert(
                        "INVALID-RISK|" +
                        closedM5,
                        "CFIP CLEAN42 FALSE SIGNAL RISK | " +
                        (_plan.Direction == 1
                            ? "BUY"
                            : "SELL"),
                        0,
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "INVALID|" +
                    closedM5,
                    "CFIP CLEAN42 SETUP UNDER PRESSURE | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | " +
            ...
            double market)
        {
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "STRUCT-INVALID|" +
                    closedM5,
                    "CFIP CLEAN42 STRUCTURAL INVALIDATION | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | SCORE " +
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN42 plan label failed: {0}",
                    ex.Message);
            }
        }
            ...
            bool visible)
        {
            ...
            {
                Print(
                    "CFIP CLEAN42 level render failed [{0}]: {1}",
                    name,
                    ex.Message);
            }
        }
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN42 icon render failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void CreatePanel()
        {
            ...
            {
                Print(
                    "CFIP CLEAN42 panel creation failed: {0}",
                    ex.Message);
        ...
        private void CreatePanelToggleButton()
        {
            ...
            {
                Print(
                    "CFIP CLEAN42 panel toggle failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void SetPanelToggleAlignment()
        {
            ...
            {
                case CFIPClean42PanelCorner.TopLeft:
                ...
                case CFIPClean42PanelCorner.TopRight:
                    _panelToggleButton.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _panelToggleButton.HorizontalAlignment =
                ...
                case CFIPClean42PanelCorner.BottomRight:
                    _panelToggleButton.VerticalAlignment =
            ...
            int contentWidth)
        {
            ...
            AddPanelRow(
                ...
                "  •  " +
                (SizingMode ==
                    CFIPClean42SizingMode.FixedLots
                    ? "FIXED " +
            ...
            string message)
        {
            ...
            if (_popup == null)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN42 popup creation failed: {0}",
                        ex.Message);
            ...
            switch (PopupPosition)
            {
                ...
                case CFIPClean42PanelCorner.BottomLeft:
                    _popup.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _popup.HorizontalAlignment =
                        HorizontalAlignment.Left;
            ...
            bool critical)
        {
            ...
            if (EnableSoundAlerts)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN42 sound alert failed: {0}",
                        ex.Message);
                }
            }
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN42 broker protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN42 auto trade failed: {0}",
                    ex.Message);
            }
        }
            ...
            double stopPips)
        {
            ...
            {
                Print(
                    "CFIP CLEAN42 volume calculation failed: {0}",
                    ex.Message);
        ...
        private double AutoTarget(
            Plan plan,
            CFIPClean42TargetStage stage)
        {
            if (stage ==
                    CFIPClean42TargetStage.TP4 &&
                plan.Tp4 > 0)
                return plan.Tp4;

            if (stage ==
                    CFIPClean42TargetStage.TP3 &&
                plan.Tp3 > 0)
                return plan.Tp3;

            if (stage ==
                    CFIPClean42TargetStage.TP2 &&
                plan.Tp2 > 0)
                return plan.Tp2;
            ...
            double price)
        {
            ...
            {
                Print(
                    "CFIP CLEAN42 prediction render failed: {0}",
                    ex.Message);
            }
        }
            ...
            int closedM5)
        {
            ...
            SendUnifiedAlert(
                ...
                "|" +
                opposite,
                "CFIP CLEAN42 ACTIVE PLAN INVALIDATED | " +
                (opposite == 1
                    ? "BUY"
                    : "SELL") +
                " REVERSAL | Q " +
        ...
        private double AggressiveTargetRR()
        {
            ...
            {
                case CFIPClean42TargetStage.TP4:
                    return Math.Max(
                        3.0,
                        Tp4MinimumRR);

                case CFIPClean42TargetStage.TP3:
                    return Math.Max(
                        2.5,
                        Tp3MinimumRR);

                case CFIPClean42TargetStage.TP2:
                    return Math.Max(
                        2.0,
                        Tp2MinimumRR);
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN42 aggressive protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN42 aggressive auto trade failed: {0}",
                    ex.Message);
            }
        }
