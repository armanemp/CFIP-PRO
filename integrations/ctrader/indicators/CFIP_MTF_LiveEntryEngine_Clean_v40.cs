// ============================================================================
// CFIP-PRO · Clean Unified MTF Live Entry Engine v40
// ============================================================================
...
namespace cAlgo
{
    public enum CFIPClean40PanelCorner
    {
        TopLeft,
        TopRight,
        BottomLeft,
    ...
    public enum CFIPClean40SizingMode
    {
        RiskPercentEquity = 0,
        FixedLots = 1
    }

    public enum CFIPClean40TargetStage
    {
        TP1 = 0,
        TP2 = 1,
        TP3 = 2,
    ...
    public class CFIP_MTF_LiveEntryEngine_Clean_v40 : Indicator
    {
        ...
        [Parameter("Sizing Mode", Group = "13 · Auto Trading", DefaultValue = CFIPClean40SizingMode.RiskPercentEquity)]
        public CFIPClean40SizingMode SizingMode { get; set; }
        ...
        [Parameter("Auto TP Stage", Group = "13 · Auto Trading", DefaultValue = CFIPClean40TargetStage.TP2)]
        public CFIPClean40TargetStage AutoTpStage { get; set; }
        ...
        [Parameter("Auto Trade Label", Group = "13 · Auto Trading", DefaultValue = "CFIP-SMART-CLEAN40")]
        ...
        [Parameter("Panel Position", Group = "14 · Display", DefaultValue = CFIPClean40PanelCorner.BottomLeft)]
        public CFIPClean40PanelCorner PanelPosition { get; set; }
        ...
        [Parameter("Panel Background Alpha", Group = "14 · Display", DefaultValue = 155, MinValue = 0, MaxValue = 255)]
        ...
        [Parameter("Include Spread In Risk Sizing", Group = "23 · Safety & Precision", DefaultValue = true)]
        ...
        [Parameter("Managed Actions Only", Group = "23 · Safety & Precision", DefaultValue = false)]
        ...
        [Parameter("Popup Position", Group = "18 · Alerts", DefaultValue = CFIPClean40PanelCorner.TopRight)]
        public CFIPClean40PanelCorner PopupPosition { get; set; }
        ...
        [Parameter("Aggressive TP Stage", Group = "21 · Auto Intelligence", DefaultValue = CFIPClean40TargetStage.TP1)]
        public CFIPClean40TargetStage AggressiveTpStage { get; set; }
        ...
        private const string P = "CFIP_CLEAN40_";
        private const string H = "CFIP_CLEAN40_H_";
        ...
        private Native RegisterNative(Bars bars)
        {
            ...
            {
                Print(
                    "CFIP CLEAN40 indicator initialization failed: {0}",
                    ex.Message);
            }
            ...
            int closedM5)
        {
                ...
                AlertOnExitPlanUpdate)
            {
                SendUnifiedAlert(
                    ...
                    "|" +
                    Price(_plan.Tp1),
                    "CFIP CLEAN40 SMART PLAN UPDATE | SL " +
                    Price(_plan.Stop) +
                    " | TP1 " +
                    Price(_plan.Tp1) +
                    " | EXIT " +
                    ...
                    false))
            {
                SendUnifiedAlert(
                    "INVALIDPLAN|" +
                    _plan.CreatedM5,
                    "CFIP CLEAN40 PLAN INVALIDATED | STRUCTURE / RR / SPREAD GUARD",
                    _plan.Direction,
                    true);
                    ...
                    FalseSignalAdverseR))
            {
                    ...
                    closedM5)
                {
                    ...
                    SendUnifiedAlert(
                        "INVALID-RISK|" +
                        closedM5,
                        "CFIP CLEAN40 FALSE SIGNAL RISK | " +
                        (_plan.Direction == 1
                            ? "BUY"
                            : "SELL"),
                        0,
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "INVALID|" +
                    closedM5,
                    "CFIP CLEAN40 SETUP UNDER PRESSURE | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | " +
            ...
            double market)
        {
                ...
                closedM5)
            {
                SendUnifiedAlert(
                    "STRUCT-INVALID|" +
                    closedM5,
                    "CFIP CLEAN40 STRUCTURAL INVALIDATION | " +
                    (_plan.Direction == 1
                        ? "BUY"
                        : "SELL") +
                    " | SCORE " +
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN40 plan label failed: {0}",
                    ex.Message);
            }
        }
            ...
            bool visible)
        {
            ...
            {
                Print(
                    "CFIP CLEAN40 level render failed [{0}]: {1}",
                    name,
                    ex.Message);
            }
        }
            ...
            Color color)
        {
            ...
            {
                Print(
                    "CFIP CLEAN40 icon render failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void CreatePanel()
        {
            ...
            {
                Print(
                    "CFIP CLEAN40 panel creation failed: {0}",
                    ex.Message);
        ...
        private void CreatePanelToggleButton()
        {
            ...
            {
                Print(
                    "CFIP CLEAN40 panel toggle failed: {0}",
                    ex.Message);
            }
        }
        ...
        private void SetPanelToggleAlignment()
        {
            ...
            {
                case CFIPClean40PanelCorner.TopLeft:
                ...
                case CFIPClean40PanelCorner.TopRight:
                    _panelToggleButton.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _panelToggleButton.HorizontalAlignment =
                ...
                case CFIPClean40PanelCorner.BottomRight:
                    _panelToggleButton.VerticalAlignment =
            ...
            int buttonGap)
        {
            ...
            if (_closeButton != null)
            {
                ...
                _closeButton.HorizontalAlignment =
            ...
            if (_cancelButton != null)
            {
                ...
                _cancelButton.HorizontalAlignment =
                    HorizontalAlignment.Stretch;
            ...
            string message)
        {
            ...
            if (_popup == null)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN40 popup creation failed: {0}",
                        ex.Message);
            ...
            switch (PopupPosition)
            {
                ...
                case CFIPClean40PanelCorner.BottomLeft:
                    _popup.VerticalAlignment =
                        VerticalAlignment.Bottom;
                    _popup.HorizontalAlignment =
                        HorizontalAlignment.Left;
            ...
            bool critical)
        {
            ...
            if (EnableSoundAlerts)
            {
                ...
                {
                    Print(
                        "CFIP CLEAN40 sound alert failed: {0}",
                        ex.Message);
                }
            }
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN40 broker protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN40 auto trade failed: {0}",
                    ex.Message);
            }
        }
            ...
            double stopPips)
        {
            try
            {
                ...
                if (SizingMode ==
                    CFIPClean40SizingMode.FixedLots)
                {
                    volume =
            ...
            {
                Print(
                    "CFIP CLEAN40 volume calculation failed: {0}",
                    ex.Message);
        ...
        private double AutoTarget(
            Plan plan,
            CFIPClean40TargetStage stage)
        {
            if (stage ==
                    CFIPClean40TargetStage.TP4 &&
                plan.Tp4 > 0)
                return plan.Tp4;

            if (stage ==
                    CFIPClean40TargetStage.TP3 &&
                plan.Tp3 > 0)
                return plan.Tp3;

            if (stage ==
                    CFIPClean40TargetStage.TP2 &&
                plan.Tp2 > 0)
                return plan.Tp2;
            ...
            double price)
        {
            ...
            {
                Print(
                    "CFIP CLEAN40 prediction render failed: {0}",
                    ex.Message);
            }
        }
            ...
            int closedM5)
        {
            ...
            SendUnifiedAlert(
                ...
                "|" +
                opposite,
                "CFIP CLEAN40 ACTIVE PLAN INVALIDATED | " +
                (opposite == 1
                    ? "BUY"
                    : "SELL") +
                " REVERSAL | Q " +
        ...
        private double AggressiveTargetRR()
        {
            ...
            {
                case CFIPClean40TargetStage.TP4:
                    return Math.Max(
                        3.0,
                        Tp4MinimumRR);

                case CFIPClean40TargetStage.TP3:
                    return Math.Max(
                        2.5,
                        Tp3MinimumRR);

                case CFIPClean40TargetStage.TP2:
                    return Math.Max(
                        2.0,
                        Tp2MinimumRR);
            ...
            int closedM5)
        {
            ...
            try
            {
                ...
                if (AutoBrokerProtection)
                {
                    ...
                    {
                        Print(
                            "CFIP CLEAN40 aggressive protection failed: {0}",
                            ex.Message);
                    }
                }
            ...
            {
                Print(
                    "CFIP CLEAN40 aggressive auto trade failed: {0}",
                    ex.Message);
            }
        }
